...
import com.example.springdata.db.entities.lazyeager.ChildLL;
import com.example.springdata.db.entities.lazyeager.ParentLL;
import com.example.springdata.db.repositories.lazyeager.ChildLLRepository;
import com.example.springdata.db.repositories.lazyeager.ParentLLRepository;
...
public class LazyParentFetchLazyChildFetchTest extends AbstractUnitTest {
    ...
    @Test
    @Transactional
    public void whenReadFromParentRepository_givenLazyParentFetchAndLazyChildFetch_shouldExecuteOneSqlRequest() {
